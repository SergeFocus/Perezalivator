...
Перем УправляемыйИнтерфейс, ФормаВыбораНастроек, ПолеФормыРасширений, АресХранилищПоУмолчанию,ЛогинХранилищПоУмолчанию,ПарольХранилищПоУмолчанию,СтраницыНастроекРасширений,СтраницаСпискаРасширений,СтраницаНастроек,КнопкаОбновленияРасширений,ГруппаСписковРасширенийДляСкрытия;
...
Процедура Инициализация()
	...
	ТаблицаБазаПриемник.Колонки.Добавить("ИмяБазыИсточника");
...
Процедура ПриИзменииПолеСоСпискомПриемник() Экспорт
	...
	ИспользуетсяПроверкаРасширений = ТаблицаРасширений.НайтиСтроки(Новый Структура("ИндексБазыПриемник",ИндексБазыПриемник)).Количество() > 0;
