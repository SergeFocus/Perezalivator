...
Перем КонтрольАктивныхСеансовПройден, ИндексБазыИсточник, ИндексБазыПриемник, ТипПодключенияКБазе;
...
Процедура ПриОткрытииФормы() Экспорт
	...
	// ПолеТипПодключенияКБазе
	Данные = Новый Соответствие; 
	Данные.Вставить("Через имя базы в v8i", 0);
	Данные.Вставить("Через строку подключения", 1);
	
	ПолеФормы = ФормаВыбораНастроек.Элементы.Добавить("ПолеТипПодключенияКБазе", "ПолеФормы", Неопределено);
	ПолеФормы.Заголовок = "Тип подключения к базе";
	ПолеФормы.Вид = ФормаВыбораНастроек.ВидПоляФормы.ПолеСоСписком;
	ПолеФормы.СписокВыбора = Данные;
	ПолеФормы.Значение = 0;
	ПолеФормы.УстановитьДействие(ЭтотОбъект, "ПриИзменении", "ПриИзменииПолеТипПодключенияКБазе");
...
//******************************************************************
Процедура ПриИзменииПолеТипПодключенияКБазе() Экспорт
	
	ТипПодключенияКБазе = ФормаВыбораНастроек.Элементы.Найти("ПолеТипПодключенияКБазе").Значение;
