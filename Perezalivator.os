...
Перем УправляемыйИнтерфейс, ФормаВыбораНастроек, ПолеФормыРасширений;
...
Процедура ПриОткрытииФормы() Экспорт
	...
	Страницы = ФормаВыбораНастроек.Элементы.Добавить("СтраницыРасширений", "ГруппаФормы", Неопределено);	
	Страницы.Вид = ФормаВыбораНастроек.ВидГруппыФормы.Страницы;	
	Страницы.Заголовок = "Страницы";	
	Страницы.Высота = 400;		
	
	СтраницаСпискаРасширений = ФормаВыбораНастроек.Элементы.Добавить("СтраницаСпискаРасширений", "ГруппаФормы", Страницы);	
	...
	Кнопка = ФормаВыбораНастроек.Элементы.Добавить("КнопкаОбновитьСписокРасширений", "КнопкаФормы", СтраницаСпискаРасширений);
	...
	СтраницаНастроек = ФормаВыбораНастроек.Элементы.Добавить("СтраницаНастроек", "ГруппаФормы", Страницы);	
	СтраницаНастроек.Вид = ФормаВыбораНастроек.ВидГруппыФормы.Страница;
	СтраницаНастроек.Заголовок = "Настройки подключений";	
	
	ПолеВводаАресХранилищПоУмолчанию = ФормаВыбораНастроек.Элементы.Добавить("АресХранилищПоУмолчанию", "ПолеФормы", СтраницаНастроек);
...
Функция ВыполнитьОбработку(НетДоступаККонсолиКластера=Ложь)
	...
	Если Не БылиОшибки И ЗначениеЗаполнено(БазаПриемник.ПроизвольныйКодПослеВсехОперацийДоСнятияБлокировки) Тогда
		Запуск1С.ПараметрыЗапуска.ИмяРасширения = "ВыполнениеКодаИзПерезаливатора";
