...
Перем Логирование, УправлениеЭП, TelegramBotID;
...
Функция ВыполнитьОбработку(НетДоступаККонсолиКластера=Ложь)
	...
	Если ЗначениеЗаполнено(БазаПриемник.АдресХранилища) И Не БылиОшибки Тогда
	...
	Если НЕ ТаблицаРасширенийВБазе = Неопределено И Не БылиОшибки Тогда
		Для Каждого Расширение Из ТаблицаРасширенийВБазе Цикл
