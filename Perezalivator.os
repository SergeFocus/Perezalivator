...
Перем ТаблицаБазаИсточник, ТаблицаБазаПриемник, ТаблицаПользователи, ТаблицаРасширений;
...
Процедура Инициализация()
	...
	ТаблицаРасширений.Колонки.Добавить("Использовать");
	...
	ТаблицаРасширений.Колонки.Добавить("ПутьКХранилищу");
	ТаблицаРасширений.Колонки.Добавить("Логин");
	ТаблицаРасширений.Колонки.Добавить("Пароль");
...
Процедура ПриНажатииНаКнопкуОбновитьСписокРасширений() Экспорт
	...
	ТаблицаРасширений = Запуск1С.ПолучитьСписокРасширений();
	Если ТаблицаРасширений = Неопределено Тогда
		//тогда произошла ошибка
	Иначе
		Сообщить(ТаблицаРасширений.Количество());
	КонецЕсли;
